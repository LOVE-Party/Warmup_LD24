...
menu_list = {
	...
	ability_hit  = menu_main{
		display = menu_display{timer = 1; text = "It hit!"; exit = turn};
	};
	ability_miss = menu_main{
		display = menu_display{timer = 1; text = "It missed!"; exit = turn};
	};
